...
Kategoria: [MVP] Opis: Jednorazowe uruchomienie skanera historii w celu zbudowania startowej bazy wiedzy.
...
Kategoria: [MVP] Opis: Implementacja dwupoziomowej struktury danych zgodnie z ustaleniami.
...
Kategoria: [MVP] Opis: Cykliczny proces analizujący manualne interwencje w celu aktualizacji bazy.
...
Kategoria: [MVP] Opis: Budowanie profilu delegata na podstawie treści zadań, które są mu zlecane (zarówno automatycznie, jak i ręcznie).
...
Kategoria: [MVP] Opis: Rozróżnienie niechcianych wiadomości od raportów systemowych.
