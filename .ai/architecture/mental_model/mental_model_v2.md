...
Krytyczna dla mechanizmu "Diff Logic". Przechowuje to, co AI _chciało_ wysłać.
...
- **Krok 2 (Summarize - Batch):** Raz na cykl (np. tydzień) dla kontaktów ze zmienionymi tagami:
  - Prompt LLM: _"Based on these keywords: [tag1, tag2, ...], write a concise 1-sentence description of this person's responsibilities."_
...
2. **Draft Matching:**
   ...
   - _Mitigation:_ System próbuje matchować po `Thread-ID` jeśli `Message-ID` zawiedzie, ale z mniejszą pewnością.
3. **Latency:**
