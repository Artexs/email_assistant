...
Uwagi / Alternatywy:
* Odrzucono rekomendację (Runda 3, Pkt 7), aby w MVP zaimplementować prosty "Audyt Użytkownika" jako krytyczny dla zaufania. Użytkownik zdecydował o odłożeniu *całego* tematu logowania.
...
* **Przenoszenie Emaili:** Przenoszenie emaili między folderami *musi* działać nawet w trybie testowym (jest to krytyczna funkcjonalność).
